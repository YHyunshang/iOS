...
//  YHFresh
//
//  Created by Yangli on 2018/11/19.
//  Copyright © 2018年 yonghui. All rights reserved.
//
...
@implementation YHGCDTimer

+ (instancetype)sharedInstance
{
    static YHGCDTimer *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[YHGCDTimer alloc] init];
    });
    return instance;
}
